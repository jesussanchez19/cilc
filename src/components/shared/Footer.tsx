        ...
        <div className="pt-8" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6 text-xs">
              <Link href="/aviso-de-privacidad" className="text-slate-600 hover:text-slate-300 transition-colors duration-150">Privacidad</Link>
              <Link href="/terminos-y-condiciones" className="text-slate-600 hover:text-slate-300 transition-colors duration-150">Términos</Link>
