        ...
        <section className="py-24" style={{ background: 'var(--dark)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {VALUE_PROPS.map(({ icon, title, desc, accent }, i) => (
                ...
                >
                  {/* Fondo teñido con el acento de la tarjeta.
                      Antes era una foto de `/images/card-*.jpg`, pero esos seis
                      archivos no existen: la carpeta solo tiene las de países y
                      programas. El navegador no pinta nada cuando un
                      `background-image` da 404, asi que las seis tarjetas se
                      veian planas e iguales, y ademas se pedian seis imagenes
                      que siempre fallaban.
                      El degradado usa el color que cada tarjeta ya traia, así
                      que se distinguen entre sí sin depender de ningún archivo. */}
                  <div
                    className="absolute inset-0 transition-transform duration-500 scale-105 group-hover:scale-100"
                    style={{
                      background: `radial-gradient(ellipse 120% 100% at 15% 0%, ${accent}38 0%, transparent 62%), linear-gradient(160deg, #16213a 0%, #0f172a 100%)`,
                    }}
                  />
                  <div className="absolute inset-0 transition-colors duration-300 bg-[#0f172a]/35 group-hover:bg-[#0f172a]/20" />
