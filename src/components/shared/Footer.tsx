      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-14">
          ...
          <div className="md:col-span-4">
            <div className="mb-1">
              <span className="text-2xl font-extrabold text-white tracking-tight gradient-text">CILC</span>
            </div>
            <p className="text-slate-500 text-xs mb-4 font-medium tracking-wide uppercase">
              Canadian &amp; International Language Centers
            </p>
            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                { label: 'Instagram', href: '#', icon: 'M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z M2 9h4v12H2z M4 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4z' },
                { label: 'LinkedIn', href: '#', icon: 'M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z M2 9h4v12H2z M4 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4z' },
              ].map(({ label, href }) => (
                <a
                  key={label}
                  href={href}
