...
const TOOLTIPS: Record<string, string> = {
  ...
  'Inglés, Francés, Alemán, Japonés, Coreano y Mandarín': 'Ofrecemos programas en los idiomas más demandados a nivel mundial, cada uno estudiado en su país de origen para una inmersión real.',
  'Múltiples destinos disponibles': 'Elige entre más de 16 países: Reino Unido, Irlanda, Canadá, Australia, Malta, Francia, Alemania, Japón, Corea del Sur y más.',
  // highlights — Au Pair
  'Estipendio semanal garantizado': 'Recibes un pago semanal (stipend) directamente de la familia anfitriona, establecido por el programa y la regulación migratoria del país.',
  'Seguro médico incluido': 'Cobertura médica completa durante toda tu estancia, proporcionada por la agencia o la familia anfitriona según el país de destino.',
  ...
  'Clases de idioma incluidas': 'Acceso a clases del idioma local como parte de los beneficios del programa, para que aproveches tu estancia al máximo.',
  ...
  'Integración al sistema académico oficial': 'Estudias en una escuela o universidad local junto con estudiantes del país, cursando el mismo plan de estudios oficial.',
  'Secundaria, Preparatoria o Universidad': 'Opciones disponibles para todos los niveles educativos, desde educación media hasta licenciatura y posgrado en el extranjero.',
  'Alojamiento con familia anfitriona o residencia': 'Alojamiento supervisado: familia anfitriona seleccionada o residencia estudiantil certificada, según tu preferencia y destino.',
  'Certificado académico reconocido': 'Las calificaciones y el periodo cursado quedan registrados en un certificado oficial emitido por la institución en el extranjero.',
  'Experiencia multicultural transformadora': 'Convivir con estudiantes de todo el mundo en un entorno académico real es una de las experiencias más formativas de tu vida.',
  // highlights — Estudia y Trabaja
  'Permiso legal para trabajar': 'El programa incluye la autorización migratoria para trabajar parcialmente durante tu estancia, conforme a la regulación de cada país.',
  'Experiencia laboral internacional': 'Trabajas en empresas reales del país destino, construyendo un historial laboral internacional valorado en el mercado global.',
  'Cobertura parcial de gastos': 'Los ingresos generados durante tu estancia pueden cubrir parte de tus gastos de vida, reduciendo el costo total del programa.',
  'Ventaja competitiva en tu CV': 'Combinar estudios con experiencia laboral internacional es una de las diferencias más valoradas por empleadores y posgrados.',
  // highlights — Formación Corporativa
  'Idiomas ejecutivos: inglés, francés, alemán, japonés, mandarín': 'Programas de idioma diseñados para entornos de negocios: negociación, presentaciones, correo formal y comunicación ejecutiva.',
  'Visitas corporativas y networking internacional': 'Organizamos visitas a empresas referentes, cámaras de comercio y eventos de networking en el país destino.',
  'Formación en comercio internacional y tecnología': 'Programas especializados en comercio internacional, inteligencia artificial, marketing digital y finanzas globales.',
  'Programas intensivos para directivos': 'Formatos de alta intensidad diseñados para aprovechar al máximo el tiempo de ejecutivos y directivos con agenda apretada.',
  'Diagnóstico personalizado para cada empresa': 'Antes de diseñar el programa realizamos un diagnóstico profundo de las necesidades, objetivos y presupuesto de tu organización.',
  // highlights — Idiomas en Línea
  'Clases en vivo con profesor calificado': 'Cada sesión es en tiempo real con un profesor certificado — no cursos grabados. Aprendes con interacción y retroalimentación inmediata.',
  'Grupos reducidos o clases individuales': 'Elige entre grupos de máximo 6 personas para practicar con compañeros, o clases uno a uno para un aprendizaje más personalizado.',
  'Inglés, Francés y Alemán': 'Los tres idiomas europeos más solicitados disponibles en línea, desde nivel básico A1 hasta avanzado C1, con certificación internacional.',
  'Evaluación de nivel inicial gratuita': 'Realizamos una evaluación sin costo antes de iniciar para ubicarte en el nivel correcto y recomendarte el programa ideal.',
  'Horarios flexibles adaptados a ti': 'Horarios disponibles mañana, tarde y noche de lunes a sábado para que puedas estudiar sin interrumpir tu rutina.',
  // includes
  'Selección de país y escuela': 'Te asesoramos para elegir el destino y la escuela que mejor se adaptan a tu objetivo, nivel de idioma y presupuesto.',
  'Selección del país y escuela ideal': 'Te asesoramos para elegir el destino y la escuela que mejor se adaptan a tu objetivo, nivel de idioma y presupuesto.',
  'Inscripción oficial en la escuela': 'Gestionamos tu registro directamente con la institución y te enviamos la carta de aceptación oficial.',
