      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          >
            ...
            {/* Stars */}
            <div className="flex justify-center gap-1 mb-5" aria-label={`${t.calificacion ?? 5} estrellas`}>
              {[1, 2, 3, 4, 5].map((s) => (
                <svg key={s} className="w-5 h-5" fill={(t.calificacion ?? 5) >= s ? '#f59e0b' : 'rgba(255,255,255,0.15)'} viewBox="0 0 20 20">
